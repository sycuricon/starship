...
with open(f'build/{source}/wave/event.log', 'r') as file:
    for line in file:
        ...
        match type:
            ...
            case "INFO_TRAIN_START_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="dashdot", line_color="yellow", annotation_text="TSC", annotation_position="bottom right")
            case "INFO_TRAIN_END_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="solid", line_color="yellow", annotation_text="TEC", annotation_position="bottom right")
            ...
            case "INFO_DELAY_START_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="dashdot", line_color="green", annotation_text="DSC", annotation_position="top right")
            case "INFO_DELAY_END_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="solid", line_color="green", annotation_text="DEC", annotation_position="top right")
            ...
            case "INFO_TEXE_START_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="dashdot", line_color="blue", annotation_text="ESC", annotation_position="top right")
            case "INFO_TEXE_END_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="solid", line_color="blue", annotation_text="EEC", annotation_position="top right")
            ...
            case "INFO_LEAK_START_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="dashdot", line_color="red", annotation_text="LSC", annotation_position="bottom right")
            case "INFO_LEAK_END_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="solid", line_color="red", annotation_text="LEC", annotation_position="bottom right")
            ...
            case "INFO_VCTM_START_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="dashdot", line_color="black", annotation_text="VSC", annotation_position="top right")
            case "INFO_VCTM_END_COMMIT":
                fig.add_vline(x=time, line_width=2, line_dash="solid", line_color="black", annotation_text="VEC", annotation_position="top right")
